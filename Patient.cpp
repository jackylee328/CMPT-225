...
bool Patient::operator==(const Patient & rhs){
    return (careCard == rhs.getCareCard());
}

// Description: Greater than operator. Compares "this" Patient object with "rhs" Patient object.
// Returns true if the care card number of "this" Patient object is >
// the care card number of "rhs" Patient object.
bool Patient::operator>(const Patient & rhs){
    return (careCard > rhs.getCareCard());
}
